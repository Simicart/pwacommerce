...
class Simi_Simipwa_Model_Simiobserver
{
    ...
    public function controllerActionPredispatch($observer)
    {
        ...
        */
        ...
        $redirect_mobile_only = (int) Mage::getStoreConfig('simipwa/general/pwa_mobile_only');
    ...
    public function renderPWA($type,$observer){
        ...
        if (file_exists($pwa_html)) {
            $dynamic_rendering = (int) Mage::getStoreConfig('simipwa/general/dynamic_rendering');
