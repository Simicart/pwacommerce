...
class Simi_Simipwa_Block_Adminhtml_Pwa_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    $send_message->addField(
        'notice_type', 'select', array(
